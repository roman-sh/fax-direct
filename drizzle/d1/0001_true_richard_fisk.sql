...
INSERT INTO `__new_fax_transmissions`("transaction_id", "session_id", "provider_status", "pages_submitted", "pages_sent", "attempts_made", "attempts_total", "resolution", "submitted_at", "updated_at", "completed_at") SELECT "transaction_id", "session_id", "provider_status", "pages_submitted", "pages_sent", "attempts_made", "attempts_total", "resolution", "submitted_at", "updated_at", "completed_at" FROM `fax_transmissions`;--> statement-breakpoint
