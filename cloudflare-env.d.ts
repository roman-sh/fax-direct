/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: f2adc13ae77c33eb271c0532bf30a40d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOOK_API_KEY" | "SESSION_COOKIE_PASSWORD" | "NEXTJS_ENV">> {}
}
declare module "*.sql" {
	const value: string;
