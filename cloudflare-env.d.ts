/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: f7f207e749a105cd4a4ee8170fe718b1)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	PAYME_BASE_URL: "https://sandbox.payme.io/api";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYME_BASE_URL" | "PAYME_CALLBACK_URL" | "POSTHOOK_API_KEY" | "SESSION_COOKIE_PASSWORD" | "NEXTJS_ENV" | "INTERFAX_USERNAME" | "INTERFAX_PASSWORD" | "INTERFAX_TEST_FAX_NUMBER" | "PAYME_SELLER_ID">> {}
}
declare module "*.sql" {
	const value: string;
