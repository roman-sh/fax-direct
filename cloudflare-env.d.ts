/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 19888ee5b219ed5bc44fc984b5b4696f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOOK_API_KEY" | "SESSION_COOKIE_PASSWORD" | "NEXTJS_ENV" | "INTERFAX_USERNAME" | "INTERFAX_PASSWORD" | "INTERFAX_TEST_FAX_NUMBER">> {}
}
declare module "*.sql" {
	const value: string;
