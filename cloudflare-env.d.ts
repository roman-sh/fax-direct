/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 0ecd22eeed0b6c578f7ed1f271cea2b7)
// Runtime types generated with workerd@1.20260801.1 2026-07-28 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MARKET_CONFIG: KVNamespace;
	FAX_DOCUMENTS: R2Bucket;
	APP_DATABASE: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	PAYME_BASE_URL: "https://live.payme.io/api";
	PAYME_CALLBACK_URL: "https://fax.direct/api/webhooks/payment";
	PAYME_RETURN_URL: "https://fax.direct";
	POSTHOOK_API_KEY: string;
	SESSION_COOKIE_PASSWORD: string;
	NEXTJS_ENV: string;
	INTERFAX_USERNAME: string;
	INTERFAX_PASSWORD: string;
	INTERFAX_TEST_FAX_NUMBER: string;
	PAYME_SELLER_ID: string;
	FAX_SESSIONS: DurableObjectNamespace<import("./worker").FaxSession>;
	FAX_POLLING_COORDINATOR: DurableObjectNamespace<import("./worker").FaxPollingCoordinator>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "FaxSession" | "FaxPollingCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYME_BASE_URL" | "PAYME_CALLBACK_URL" | "PAYME_RETURN_URL" | "POSTHOOK_API_KEY" | "SESSION_COOKIE_PASSWORD" | "NEXTJS_ENV" | "INTERFAX_USERNAME" | "INTERFAX_PASSWORD" | "INTERFAX_TEST_FAX_NUMBER" | "PAYME_SELLER_ID">> {}
}
declare module "*.sql" {
	const value: string;
